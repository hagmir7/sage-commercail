...
public function index(Request $request)
{
    ...
    // ── DB-level sort only for DB columns ─────────────────────────────────────
    ...
    // ── Enrich every record with computed fields ──────────────────────────────
    $all->transform(function ($article) use ($company) {
    ...
    // ── Manual pagination over the sorted+filtered collection ─────────────────
